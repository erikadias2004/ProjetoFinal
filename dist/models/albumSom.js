...
let AlbumSong = (() => {
    ...
    var AlbumSong = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            this.albumId = __runInitializers(this, _albumId_initializers, void 0);
            this.songId = (__runInitializers(this, _albumId_extraInitializers), __runInitializers(this, _songId_initializers, void 0));
            __runInitializers(this, _songId_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "AlbumSong");
    (() => {
        var _a;
        ...
        _songId_decorators = [(0, sequelize_typescript_1.ForeignKey)(() => musicas_1.Song), (0, sequelize_typescript_1.Column)({
                type: 'number'
            })];
        ...
        AlbumSong = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AlbumSong = _classThis;
})();
exports.AlbumSong = AlbumSong;
