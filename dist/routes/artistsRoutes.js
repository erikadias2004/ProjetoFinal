...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const artists = yield artista_1.Artista.findAll();
    res.render('artists', { artists });
}));
router.post('/create', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name } = req.body;
    yield artista_1.Artista.create({ name });
    res.redirect('/artists');
}));
router.post('/delete/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    yield artista_1.Artista.destroy({ where: { id } });
    res.redirect('/artists');
}));
router.post('/update/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { name } = req.body;
    yield artista_1.Artista.update({ name }, { where: { id } });
    res.redirect('/artists');
}));
